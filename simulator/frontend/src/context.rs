...
pub struct Ctx {
    ...
    pub slice_size: Signal<[f32; 2]>,
    pub slice_res: Signal<f32>,
    pub field_dims: Signal<[u32; 2]>,
...
pub fn use_app_ctx(saved: Settings) -> Ctx {
    ...
    Ctx {
        ...
        slice_size: use_signal(|| [0.0; 2]),
        slice_res: use_signal(|| saved.slice_resolution),
        field_dims: use_signal(|| [0; 2]),
