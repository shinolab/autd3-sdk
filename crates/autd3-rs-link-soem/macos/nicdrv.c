/*
 * Derived from SOEM `contrib/oshw/macosx/nicdrv.c` (libpcap driver).
 *
 ...
 *
 * Modification for autd3-rs-link-soem (2026-06): removed the leading UTF-8 BOM;
 * verified to build against the current SOEM 2.0 core API.
 */
