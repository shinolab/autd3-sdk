...
const OUTPUT_MASK_WORDS: usize = fw::OUTPUT_MASK_WORDS;
const PWE_TABLE_SIZE: usize = fw::PWE_TABLE_SIZE;
...
const CTL_FLAG_GPIO_IN: [u16; 4] = [
    fw::CTL_FLAG_GPIO_IN_0,
    fw::CTL_FLAG_GPIO_IN_1,
    fw::CTL_FLAG_GPIO_IN_2,
    fw::CTL_FLAG_GPIO_IN_3,
];
const SILENCER_FIXED_UPDATE_RATE_MODE: u16 = fw::SILENCER_FLAG_FIXED_UPDATE_RATE_MODE as u16;

const fn reg(a: u16) -> usize {
    a as usize
}
...
impl FpgaEmulator {
    ...
    pub fn force_fan(&self) -> bool {
        self.controller[reg(fw::ADDR_CTL_FLAG)] & fw::CTL_FLAG_FORCE_FAN != 0
    }
    ...
    pub fn silencer_fixed_update_rate_mode(&self) -> bool {
        self.controller[reg(fw::ADDR_SILENCER_FLAG)] & SILENCER_FIXED_UPDATE_RATE_MODE != 0
    }

    #[must_use]
    pub fn silencer_update_rate_intensity(&self) -> u16 {
        self.controller[reg(fw::ADDR_SILENCER_UPDATE_RATE_INTENSITY)]
    }

    #[must_use]
    pub fn silencer_update_rate_phase(&self) -> u16 {
        self.controller[reg(fw::ADDR_SILENCER_UPDATE_RATE_PHASE)]
    }

    #[must_use]
    pub fn silencer_completion_steps_intensity(&self) -> u16 {
        self.controller[reg(fw::ADDR_SILENCER_COMPLETION_STEPS_INTENSITY)]
    }

    #[must_use]
    pub fn silencer_completion_steps_phase(&self) -> u16 {
        self.controller[reg(fw::ADDR_SILENCER_COMPLETION_STEPS_PHASE)]
    }
    ...
    pub fn req_modulation_bank(&self) -> u16 {
        self.controller[reg(fw::ADDR_MOD_REQ_RD_BANK)]
    }

    #[must_use]
    pub fn req_pattern_bank(&self) -> u16 {
        self.controller[reg(fw::ADDR_PATTERN_REQ_RD_BANK)]
    }
