...
sidebar:
  order: 1
slug: 0.4.x/getting-started/setup/hardware
---

ここでは, AUTD3 デバイスと PC を接続する手順を説明する.
デバイスの構成・寸法・座標系・コネクタなどの詳細は [ガイド/AUTD3](/autd3-sdk/0.4.x/hardware/board/) を参照すること.
...
配線の詳細は [ガイド/AUTD3](/autd3-sdk/0.4.x/hardware/board/#電源) を参照すること.
