...
slug: 0.2.x/api/compute/holo/greedy
---
...
共通要素 (`ControlPoint` / `TransducerMask` など) は [Holo 概要](/autd3-sdk/0.2.x/api/compute/holo/) を参照.
...
* `constraint` / `directivity` / `mask` の意味は [Holo 概要](/autd3-sdk/0.2.x/api/compute/holo/) を参照.
