...
For details of each API, refer to the [API reference](/autd3-sdk/en/api/basics/geometry/).
...
- **Pattern** — a bundle of the phase and amplitude of each transducer (a phase buffer and an intensity buffer).
