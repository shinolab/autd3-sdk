...
slug: en/0.6.x/api/compute/holo/naive
---
...
For the common elements (`AmplitudeTarget` / `TransducerMask` / `LinAlgBackend`, etc.), see the [Holo overview](/autd3-sdk/en/0.6.x/api/compute/holo/).
...
For the meaning of each field, see the [Holo overview](/autd3-sdk/en/0.6.x/api/compute/holo/).
