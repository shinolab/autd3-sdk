...
On the server-side host, also add the package of the Link that drives the real hardware (such as [EtherCrab](/autd3-sdk/en/0.6.x/api/link/ethercrab/)).

Connection to the [`Simulator`](/autd3-sdk/en/0.6.x/guide/simulator/) is also done with `RemoteLink`.
