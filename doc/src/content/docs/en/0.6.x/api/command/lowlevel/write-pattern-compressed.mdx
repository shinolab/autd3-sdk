...
sidebar:
  order: 12.5
slug: en/0.6.x/api/command/lowlevel/write-pattern-compressed
---

import CodeTabs from "@components/CodeTabs.astro";

`WritePatternCompressed` is the compressed version of [`WritePatternBuffer`](/autd3-sdk/en/0.6.x/api/command/lowlevel/write-pattern-buffer/).
