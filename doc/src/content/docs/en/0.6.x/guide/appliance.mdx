...
sidebar:
  order: 10
slug: en/0.6.x/guide/appliance
---

import CodeTabs from "@components/CodeTabs.astro";

The appliance is a dedicated board that runs nothing but the EtherCAT master.
The board owns the cable to the AUTD3 devices, and your machine connects over TCP with [`RemoteLink`](/autd3-sdk/en/0.6.x/api/link/remote/).
...
`autd3-appliance` is bundled with autd3-console ([Console](/autd3-sdk/en/0.6.x/getting-started/setup/console/)).
...
3. Connect from the host with [`RemoteLink`](/autd3-sdk/en/0.6.x/api/link/remote/)
