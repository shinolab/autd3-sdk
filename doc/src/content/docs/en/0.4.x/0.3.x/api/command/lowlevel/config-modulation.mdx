...
sidebar:
  order: 16
slug: 0.4.x/en/0.3.x/api/command/lowlevel/config-modulation
---
...
For the timing at which `loop_behavior` and the transition take effect see [ChangeModulationBank](/autd3-sdk/en/0.4.x/0.3.x/api/command/lowlevel/change-modulation-bank/).
