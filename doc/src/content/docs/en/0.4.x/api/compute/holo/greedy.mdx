...
slug: en/0.4.x/api/compute/holo/greedy
---
...
For the common elements (`ControlPoint` / `TransducerMask`, etc.), see the [Holo overview](/autd3-sdk/en/0.4.x/api/compute/holo/).
...
* For the meaning of `constraint` / `directivity` / `mask`, see the [Holo overview](/autd3-sdk/en/0.4.x/api/compute/holo/).
