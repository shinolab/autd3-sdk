...
sidebar:
  order: 15
slug: 0.5.x/en/0.3.x/api/command/lowlevel/write-modulation-buffer
---
...
An example of playing an AM waveform via `WriteModulationBuffer` → `ConfigModulation` → `ChangeModulationBank` (equivalent to the high-level [Modulation](/autd3-sdk/en/0.5.x/0.3.x/api/command/modulation/)).
