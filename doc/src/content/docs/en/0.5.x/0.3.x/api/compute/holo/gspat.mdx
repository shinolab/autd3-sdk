...
slug: 0.5.x/en/0.3.x/api/compute/holo/gspat
---

import CodeTabs from "@components/CodeTabs.astro";

gspat is an algorithm that speeds up [gs](/autd3-sdk/en/0.5.x/0.3.x/api/compute/holo/gs/).
...
The parameters are the same as [gs](/autd3-sdk/en/0.5.x/0.3.x/api/compute/holo/gs/).
...
The options are the same as [gs](/autd3-sdk/en/0.5.x/0.3.x/api/compute/holo/gs/).
