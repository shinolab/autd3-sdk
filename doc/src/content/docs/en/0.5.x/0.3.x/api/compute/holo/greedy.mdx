...
slug: 0.5.x/en/0.3.x/api/compute/holo/greedy
---
...
For the common elements (`ControlPoint` / `TransducerMask`, etc.), see the [Holo overview](/autd3-sdk/en/0.5.x/0.3.x/api/compute/holo/).
...
* For the meaning of `constraint` / `directivity` / `mask`, see the [Holo overview](/autd3-sdk/en/0.5.x/0.3.x/api/compute/holo/).
