...
slug: en/0.5.x/api/compute/holo/greedy
---
...
For the common elements (`ControlPoint` / `TransducerMask`, etc.), see the [Holo overview](/autd3-sdk/en/0.5.x/api/compute/holo/).
