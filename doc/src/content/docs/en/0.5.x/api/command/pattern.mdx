...
sidebar:
  order: 1
slug: en/0.5.x/api/command/pattern
---
...
Several [helper functions](/autd3-sdk/en/0.5.x/api/compute/pattern/) are provided for computing patterns.

## Equivalent Low-Level Commands

`Pattern` is equivalent to the three commands [WritePatternBuffer](/autd3-sdk/en/0.5.x/api/command/lowlevel/write-pattern-buffer/) + [ConfigPattern](/autd3-sdk/en/0.5.x/api/command/lowlevel/config-pattern/) + [ChangePatternBank](/autd3-sdk/en/0.5.x/api/command/lowlevel/change-pattern-bank/), which are fused into a single frame.
...
See the `TransitionMode` section of [ChangePatternBank](/autd3-sdk/en/0.5.x/api/command/lowlevel/change-pattern-bank/) for details.
