...
sidebar:
  order: 5
slug: 0.5.x/en/0.4.x/api/basics/dc-sys-time
---

import CodeTabs from "@components/CodeTabs.astro";

`DcSysTime` is a type representing a time on the **EtherCAT distributed clock (Distributed Clock, DC)**.
It is used with [`TransitionMode::SysTime`](/autd3-sdk/en/0.5.x/0.4.x/getting-started/tutorial/loop/), [`GpioOut::SysTimeEq`](/autd3-sdk/en/0.5.x/0.4.x/api/command/gpio/), and the like.
