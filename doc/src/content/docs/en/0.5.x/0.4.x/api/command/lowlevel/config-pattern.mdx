...
sidebar:
  order: 13
slug: 0.5.x/en/0.4.x/api/command/lowlevel/config-pattern
---
...
`loop_behavior` only takes effect when switching to a bank different from the current one via [ChangePatternBank](/autd3-sdk/en/0.5.x/0.4.x/api/command/lowlevel/change-pattern-bank/).
