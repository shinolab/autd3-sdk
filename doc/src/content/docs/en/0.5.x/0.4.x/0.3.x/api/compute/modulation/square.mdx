...
slug: 0.5.x/0.4.x/en/0.3.x/api/compute/modulation/square
---
...
`freq` is specified in the same way as [sine](/autd3-sdk/en/0.5.x/0.4.x/0.3.x/api/compute/modulation/sine/).
