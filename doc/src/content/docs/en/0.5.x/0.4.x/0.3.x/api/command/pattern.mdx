...
sidebar:
  order: 1
slug: 0.5.x/0.4.x/en/0.3.x/api/command/pattern
---
...
Several [helper functions](/autd3-sdk/en/0.5.x/0.4.x/0.3.x/api/compute/pattern/) are provided for computing patterns.

## Equivalent Low-Level Commands

`Pattern` internally expands into the three commands [WritePatternBuffer](/autd3-sdk/en/0.5.x/0.4.x/0.3.x/api/command/lowlevel/write-pattern-buffer/) + [ConfigPattern](/autd3-sdk/en/0.5.x/0.4.x/0.3.x/api/command/lowlevel/config-pattern/) + [ChangePatternBank](/autd3-sdk/en/0.5.x/0.4.x/0.3.x/api/command/lowlevel/change-pattern-bank/).
