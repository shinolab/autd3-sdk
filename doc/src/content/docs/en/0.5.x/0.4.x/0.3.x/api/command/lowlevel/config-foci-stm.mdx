...
sidebar:
  order: 19
slug: 0.5.x/0.4.x/en/0.3.x/api/command/lowlevel/config-foci-stm
---
...
For the timing at which `loop_behavior` and the transition take effect see [ChangePatternBank](/autd3-sdk/en/0.5.x/0.4.x/0.3.x/api/command/lowlevel/change-pattern-bank/).
