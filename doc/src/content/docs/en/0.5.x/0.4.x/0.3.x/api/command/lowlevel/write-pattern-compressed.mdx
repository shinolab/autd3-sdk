...
sidebar:
  order: 12.5
slug: 0.5.x/0.4.x/en/0.3.x/api/command/lowlevel/write-pattern-compressed
---

import CodeTabs from "@components/CodeTabs.astro";

`WritePatternCompressed` is the compressed version of [`WritePatternBuffer`](/autd3-sdk/en/0.5.x/0.4.x/0.3.x/api/command/lowlevel/write-pattern-buffer/).
