---
title: Appliance
description: Run the EtherCAT master on a dedicated board to decouple the bus
  from your host's load and OS settings
sidebar:
  order: 10
slug: en/0.5.x/guide/appliance
---

import CodeTabs from "@components/CodeTabs.astro";

The appliance is a dedicated board that runs nothing but the EtherCAT master.
The board owns the cable to the AUTD3 devices, and your machine connects over TCP with [`RemoteLink`](/autd3-sdk/en/0.5.x/api/link/remote/).
...
`autd3-appliance` is bundled with autd3-console ([Console](/autd3-sdk/en/0.5.x/getting-started/setup/console/)).
