...
sidebar:
  order: 6
slug: en/0.8.x/guide/state-check
---
...
Using `open_with_checker` instead of the usual [`Client::open`](/autd3-sdk/en/0.8.x/api/basics/client/) returns a pair of `Client` and `Checker`.
