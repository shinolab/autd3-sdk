...
sidebar:
  order: 2
slug: en/0.8.x/getting-started/appliance
---

import CodeTabs from "@components/CodeTabs.astro";

:::note
If you use [TwinCAT](/autd3-sdk/en/0.8.x/getting-started/twincat/) or [echocat](/autd3-sdk/en/0.8.x/api/link/echocat/), the steps on this page are not needed.
:::

The appliance is a dedicated board that runs nothing but the EtherCAT master.
The board owns the cable to the AUTD3 devices, and your machine connects over TCP with [`RemoteLink`](/autd3-sdk/en/0.8.x/api/link/remote/).
...
The host can be Windows, Linux, or macOS, and needs neither [TwinCAT](/autd3-sdk/en/0.8.x/getting-started/twincat/) nor npcap.
...
`autd3-appliance` is bundled with autd3-console ([Console](/autd3-sdk/en/0.8.x/guide/console/)).
...
3. Connect from the host with [`RemoteLink`](/autd3-sdk/en/0.8.x/api/link/remote/)
