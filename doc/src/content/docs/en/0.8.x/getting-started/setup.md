...
sidebar:
  order: 1
slug: en/0.8.x/getting-started/setup
---

The steps for getting started with AUTD3 are described in the following order.

* [Hardware](/autd3-sdk/en/0.8.x/getting-started/setup/hardware/): Connect the AUTD3 device to the PC.
* [Firmware](/autd3-sdk/en/0.8.x/getting-started/setup/firmware/): Update the device firmware to a compatible version.
* [Software](/autd3-sdk/en/0.8.x/getting-started/setup/software/): Add the SDK library as a dependency.
...
* [Appliance](/autd3-sdk/en/0.8.x/getting-started/appliance/) (recommended)
...
* [echocat](/autd3-sdk/en/0.8.x/api/link/echocat/)
...
* [TwinCAT](/autd3-sdk/en/0.8.x/getting-started/twincat/)
  * Windows only. Needs a supported network controller and a TwinCAT setup. The most stable of the three.

Unless there is a reason not to, the [Appliance](/autd3-sdk/en/0.8.x/getting-started/appliance/) is recommended, though it additionally requires a Raspberry Pi 4, a microSD card and a USB Ethernet adapter.
