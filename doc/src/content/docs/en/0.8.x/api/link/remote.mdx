...
Used to connect to the [Appliance](/autd3-sdk/en/0.8.x/getting-started/appliance/) or the [Simulator](/autd3-sdk/en/0.8.x/guide/simulator/).
...
On the server-side host, also add the package of the Link that drives the real hardware (such as [Echocat](/autd3-sdk/en/0.8.x/api/link/echocat/)).
...
For a real example, see the [appliance documentation](/autd3-sdk/en/0.8.x/getting-started/appliance/) and the [appliance implementation](https://github.com/shinolab/autd3-sdk/tree/main/appliance).
