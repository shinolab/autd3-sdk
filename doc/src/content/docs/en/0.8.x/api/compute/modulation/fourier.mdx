...
slug: en/0.8.x/api/compute/modulation/fourier
---
...
`fourier` generates an amplitude modulation synthesized from multiple sine-wave components. Each component is computed in the same way as [sine](/autd3-sdk/en/0.8.x/api/compute/modulation/sine/), and they are summed into a single waveform.
