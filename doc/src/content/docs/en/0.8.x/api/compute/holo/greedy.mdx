...
slug: en/0.8.x/api/compute/holo/greedy
---
...
For the common elements (`AmplitudeTarget` / `TransducerMask`, etc.), see the [Holo overview](/autd3-sdk/en/0.8.x/api/compute/holo/).
