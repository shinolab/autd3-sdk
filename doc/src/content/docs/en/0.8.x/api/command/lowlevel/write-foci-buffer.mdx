...
sidebar:
  order: 18
slug: en/0.8.x/api/command/lowlevel/write-foci-buffer
---
...
For details see [FociStm](/autd3-sdk/en/0.8.x/api/command/foci-stm/#controlpoint--controlpoints).

## Example

An example of playing a focal point sequence as Foci STM via `WriteFociBuffer` → `ConfigFociStm` → `ChangePatternBank` (equivalent to the high-level [FociStm](/autd3-sdk/en/0.8.x/api/command/foci-stm/)).
