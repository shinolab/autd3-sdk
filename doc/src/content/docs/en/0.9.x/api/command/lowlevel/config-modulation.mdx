...
sidebar:
  order: 16
slug: en/0.9.x/api/command/lowlevel/config-modulation
---
...
For the timing at which `loop_behavior` and the transition take effect see [ChangeModulationBank](/autd3-sdk/en/0.9.x/api/command/lowlevel/change-modulation-bank/).
