...
slug: en/0.9.x/api/compute/holo/gs
---
...
The parameters other than `option` are the same as [Naive](/autd3-sdk/en/0.9.x/api/compute/holo/naive/).
...
For the meaning of `constraint` / `directivity` / `mask`, see the [Holo overview](/autd3-sdk/en/0.9.x/api/compute/holo/).
