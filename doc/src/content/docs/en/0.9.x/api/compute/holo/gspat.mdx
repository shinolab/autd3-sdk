...
slug: en/0.9.x/api/compute/holo/gspat
---

import CodeTabs from "@components/CodeTabs.astro";

gspat is an algorithm that speeds up [gs](/autd3-sdk/en/0.9.x/api/compute/holo/gs/).
...
The parameters are the same as [gs](/autd3-sdk/en/0.9.x/api/compute/holo/gs/).
...
The options are the same as [gs](/autd3-sdk/en/0.9.x/api/compute/holo/gs/).
