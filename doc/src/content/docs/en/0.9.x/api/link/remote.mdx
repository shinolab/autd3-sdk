...
Used to connect to the [Appliance](/autd3-sdk/en/0.9.x/getting-started/appliance/) or the [Simulator](/autd3-sdk/en/0.9.x/guide/simulator/).
...
The server (an [Appliance](/autd3-sdk/en/0.9.x/getting-started/appliance/) or the [Simulator](/autd3-sdk/en/0.9.x/guide/simulator/)) can be found over mDNS.
...
On the server-side host, also add the package of the Link that drives the real hardware (such as [Echocat](/autd3-sdk/en/0.9.x/api/link/echocat/)).
...
For a real example, see the [appliance documentation](/autd3-sdk/en/0.9.x/getting-started/appliance/) and the [appliance implementation](https://github.com/shinolab/autd3-sdk/tree/main/appliance).
