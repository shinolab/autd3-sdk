...
sidebar:
  order: 15
slug: en/0.3.x/api/command/lowlevel/write-modulation-buffer
---
...
An example of playing an AM waveform via `WriteModulationBuffer` → `ConfigModulation` → `ChangeModulationBank` (equivalent to the high-level [Modulation](/autd3-sdk/en/0.3.x/api/command/modulation/)).
