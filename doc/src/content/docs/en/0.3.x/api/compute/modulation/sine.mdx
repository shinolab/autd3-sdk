...
slug: en/0.3.x/api/compute/modulation/sine
---
...
Due to the [constraints of SamplingConfig](/autd3-sdk/en/0.3.x/api/basics/sampling-config/), the specified frequency may not be a representable frequency.
