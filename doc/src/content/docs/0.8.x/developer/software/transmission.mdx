...
sidebar:
  order: 2
slug: 0.8.x/developer/software/transmission
---

import Mermaid from "@components/Mermaid.astro";

[DatagramBuilder](/autd3-sdk/0.8.x/developer/software/datagram-builder/) が生成した `Frame` を実際にデバイスへ送り届ける処理について述べる.
...
[DatagramBuilder](/autd3-sdk/0.8.x/developer/software/datagram-builder/) の `build` は「送れば適用される」前提で mirror を更新している.
