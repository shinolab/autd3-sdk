...
sidebar:
  order: 12.5
slug: 0.8.x/api/command/lowlevel/write-pattern-compressed
---

import CodeTabs from "@components/CodeTabs.astro";

`WritePatternCompressed` は, [`WritePatternBuffer`](/autd3-sdk/0.8.x/api/command/lowlevel/write-pattern-buffer/) の圧縮版.
