...
slug: 0.5.x/theory/radiation-pressure
---
...
平均エネルギー密度による説明は文献\[^saneyoshi\_ultrasound\_1978]などに詳しい (なお, 平均エネルギー密度による説明は, 音場が平面波に分解できるときのみ成り立つことが指摘されている\[^hasegawa1996\_jp]).
...
\[^saneyoshi\_ultrasound\_1978]: 実吉純一, "超音波技術便覧", 日刊工業新聞社, 1978.

\[^hasegawa1996\_jp]: 長谷川高陽, "ランジュバン放射圧に関する統一理論", 日本音響学会誌, 1996.
