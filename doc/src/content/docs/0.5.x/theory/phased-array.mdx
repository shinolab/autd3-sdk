...
slug: 0.5.x/theory/phased-array
---
...
<Figure src="img/theory/phasedarray/sinc.jpg" alt="sinc(x) のグラフ" />

図からわかるように <Math tex="x=\pm \pi, \pm 2\pi, \pm 3\pi,..." /> で <Math tex="\sinc(x)=0" /> になる.

また, 以下に <Math tex="\sinc(nx)/\sinc(x)" /> のグラフを載せる.

<Figure src="img/theory/phasedarray/sinc_i.jpg" alt="sinc(nx)/sinc(x) のグラフ" />
...
<Figure src="img/theory/phasedarray/x_narrow_x200.jpg" alt="x軸方向の音場 (z_f=200)" />

<Figure src="img/theory/phasedarray/x_wide_x200.jpg" alt="x軸方向の音場 (z_f=200)" caption="x軸方向の音場 (z_f=200). 焦点付近は比較的よく近似されるが, グレーティングローブ周りは近似の精度は低く, 位置も音圧もずれている." />
