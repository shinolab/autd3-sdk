...
* [Naive](/autd3-sdk/0.5.x/api/compute/holo/naive/) — 単一ステップの逆伝搬
* [GS](/autd3-sdk/0.5.x/api/compute/holo/gs/) — Gerchberg-Saxton 法
* [GS-PAT](/autd3-sdk/0.5.x/api/compute/holo/gspat/) — GS-PAT 法
* [Greedy](/autd3-sdk/0.5.x/api/compute/holo/greedy/) — 位相を貪欲に決定する組合せ最適化
