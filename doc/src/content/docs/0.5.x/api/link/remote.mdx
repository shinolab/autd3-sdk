...
サーバ側のホストには, 実機を駆動する Link のパッケージ ([EtherCrab](/autd3-sdk/0.5.x/api/link/ethercrab/) 等) も併せて追加する.

[`Simulator`](/autd3-sdk/0.5.x/guide/simulator/) への接続も`RemoteLink`で行う.
