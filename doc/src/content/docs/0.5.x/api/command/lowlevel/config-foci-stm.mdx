...
sidebar:
  order: 19
slug: 0.5.x/api/command/lowlevel/config-foci-stm
---
...
`loop_behavior` と遷移の反映タイミングは [ChangePatternBank](/autd3-sdk/0.5.x/api/command/lowlevel/change-pattern-bank/) を参照.

`size` の下限は 2.
単一焦点を静的に出したい場合は STM ではなく [Pattern](/autd3-sdk/0.5.x/api/command/pattern/) を使う.
