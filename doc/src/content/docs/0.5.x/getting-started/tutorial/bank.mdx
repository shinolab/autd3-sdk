...
sidebar:
  order: 7
slug: 0.5.x/getting-started/tutorial/bank
---

import CodeTabs from "@components/CodeTabs.astro";

[焦点の移動](/autd3-sdk/0.5.x/getting-started/tutorial/moving-focus/)で説明したように, AUTD3 において `Pattern` 等は送信するたびに上書きされ, この書き込みはバッファリングされない.
...
バンクの書き込み・設定・切り替えをより細かく制御したい場合は, API リファレンスの [低レベルコマンド](/autd3-sdk/0.5.x/api/command/lowlevel/) を参照.
