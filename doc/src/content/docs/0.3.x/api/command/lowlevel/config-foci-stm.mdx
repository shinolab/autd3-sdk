...
sidebar:
  order: 19
slug: 0.3.x/api/command/lowlevel/config-foci-stm
---
...
`loop_behavior` と遷移の反映タイミングは [ChangePatternBank](/autd3-sdk/0.3.x/api/command/lowlevel/change-pattern-bank/) を参照.
