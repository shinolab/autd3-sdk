...
sidebar:
  order: 15
slug: 0.9.x/api/command/lowlevel/write-modulation-buffer
---
...
`WriteModulationBuffer` → `ConfigModulation` → `ChangeModulationBank` で AM 波形を再生する例 (高レベルの [Modulation](/autd3-sdk/0.9.x/api/command/modulation/) と等価).
