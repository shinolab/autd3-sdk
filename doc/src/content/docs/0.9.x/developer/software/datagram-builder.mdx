...
sidebar:
  order: 1
slug: 0.9.x/developer/software/datagram-builder
---
...
送信側の詳細は[送信処理](/autd3-sdk/0.9.x/developer/software/transmission/)を参照.
...
例えば, [`Silencer`](/autd3-sdk/0.9.x/guide/silencer/) は, 不正な設定がファームウェア側で弾かれるが, この `mirror` を使うことで, 送信前に不正を検出できる.
...
詳しくは, [送信処理](/autd3-sdk/0.9.x/developer/software/transmission/) を参照.
:::
