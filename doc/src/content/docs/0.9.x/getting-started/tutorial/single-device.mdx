...
sidebar:
  order: 1
slug: 0.9.x/getting-started/tutorial/single-device
---
...
本チュートリアルでは[echocat](/autd3-sdk/0.9.x/api/link/echocat/)を利用する.
Windowsを使用する場合, [Npcap](https://npcap.com/)を「**WinPcap API-compatible Mode**」でインストールしておくこと.

:::note
`echocat` の代わりに [Remote link](/autd3-sdk/0.9.x/api/link/remote/) や [TwinCAT link](/autd3-sdk/0.9.x/api/link/twincat/) を使用することもできる.
