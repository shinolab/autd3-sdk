...
sidebar:
  order: 18
slug: 0.1.x/api/command/lowlevel/write-foci-buffer
---
...
詳細は [FociStm](/autd3-sdk/0.1.x/api/command/foci-stm/#controlpoint--controlpoints) を参照.

## Example

`WriteFociBuffer` → `ConfigFociStm` → `ChangePatternBank` で焦点列を Foci STM として再生する例 (高レベルの [FociStm](/autd3-sdk/0.1.x/api/command/foci-stm/) と等価).
