...
sidebar:
  order: 13
slug: 0.1.x/api/command/lowlevel/config-pattern
---
...
`loop_behavior` は, [ChangePatternBank](/autd3-sdk/0.1.x/api/command/lowlevel/change-pattern-bank/) で現在と異なるバンクへ切り替えたときのみ作用する.
