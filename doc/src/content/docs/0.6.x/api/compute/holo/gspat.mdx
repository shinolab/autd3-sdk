...
slug: 0.6.x/api/compute/holo/gspat
---

import CodeTabs from "@components/CodeTabs.astro";

gspat は, [gs](/autd3-sdk/0.6.x/api/compute/holo/gs/) を高速化したアルゴリズム.
...
引数は [gs](/autd3-sdk/0.6.x/api/compute/holo/gs/) と同一.
...
オプションは [gs](/autd3-sdk/0.6.x/api/compute/holo/gs/) と同一.
