...
| `autd3-rs-pattern-holo`      | 多焦点音場再構成. 理論は[理論と考察](/autd3-sdk/0.7.x/theory/holo/)を参照.  |
...
`EchocatLink` / `EtherCrabLink` はホスト自身が EtherCAT マスタとなり raw socket で PDO を直接回す.
...
* [DatagramBuilder](/autd3-sdk/0.7.x/developer/software/datagram-builder/): コマンドを送信フレームへ変換する
* [送信処理](/autd3-sdk/0.7.x/developer/software/transmission/): フレームを送出し, SEQ/ACK で多重化と回復を行う
