...
sidebar:
  order: 10
slug: 0.7.x/guide/appliance
---

import CodeTabs from "@components/CodeTabs.astro";

Appliance は, EtherCAT マスタだけを動かす専用ボード.
AUTD3 との配線をボードが持ち, ユーザのマシンは [`RemoteLink`](/autd3-sdk/0.7.x/api/link/remote/) で TCP 接続する.
...
`autd3-appliance` は autd3-console のバンドルに同梱されている ([コンソール](/autd3-sdk/0.7.x/getting-started/setup/console/)).
...
2. AUTD3 とボードの電源を入れる
3. ホストから [`RemoteLink`](/autd3-sdk/0.7.x/api/link/remote/) でつなぐ
