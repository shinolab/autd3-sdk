...
slug: 0.7.x/api/compute/holo/naive
---
...
共通要素 (`AmplitudeTarget` / `TransducerMask` / `LinAlgBackend` など) は [Holo 概要](/autd3-sdk/0.7.x/api/compute/holo/) を参照.
...
各フィールドの意味は [Holo 概要](/autd3-sdk/0.7.x/api/compute/holo/) を参照.
