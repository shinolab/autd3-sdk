...
sidebar:
  order: 16
slug: 0.7.x/api/command/lowlevel/config-modulation
---
...
`loop_behavior` と遷移の反映タイミングは [ChangeModulationBank](/autd3-sdk/0.7.x/api/command/lowlevel/change-modulation-bank/) を参照.
