...
#define CMD_WRITE_PATTERN_COMPRESSED (0x13)
#define CMD_WRITE_MOD_BUFFER (0x20)
#define CMD_CONFIG_MOD (0x21)
#define CMD_CHANGE_MOD_BANK (0x22)
#define CMD_SET_SILENCER (0x30)
#define CMD_SET_PHASE_CORR (0x40)
#define CMD_SET_OUTPUT_MASK (0x41)
#define CMD_SET_PWE (0x42)
#define CMD_EMULATE_GPIO_IN (0x50)
#define CMD_SET_GPIO_OUT (0x52)
#define CMD_FORCE_FAN (0x60)
...
#define CMD_READ_FPGA_FW_VERSION_MAJOR (0xE4)
#define CMD_READ_FPGA_FW_VERSION_MINOR (0xE5)
#define CMD_READ_FPGA_FW_VERSION_PATCH (0xE6)
#define CMD_READ_FPGA_STATE (0xE7)
...
#define EM_COMPRESSED_OFFSET_BANK (0)
#define EM_COMPRESSED_OFFSET_FORMAT (1)
#define EM_COMPRESSED_OFFSET_COUNT (2)
#define EM_COMPRESSED_OFFSET_OFFSET (4)
#define EM_COMPRESSED_OFFSET_DATA (8)

#define WRITE_PATTERN_FORMAT_PHASE_FULL (1u)
#define WRITE_PATTERN_FORMAT_PHASE_HALF (2u)
...
#define MOD_CONFIG_OFFSET_REP (8)
...
#define EM_CONFIG_OFFSET_REP (12)
...
#define FORCE_FAN_OFFSET_VALUE (0)

#define GPIO_IN_OFFSET_FLAG (0)
#define GPIO_IN_FLAG_MASK (0x0F)

#define PHASE_CORR_OFFSET_DATA (0)

#define OUTPUT_MASK_OFFSET_DATA (0)
#define OUTPUT_MASK_WORDS (((NUM_TRANSDUCERS) + 15) / 16)

#define PWE_OFFSET_DATA (0)

#define GPIO_OUT_OFFSET_DATA (0)
#define GPIO_OUT_NUM (4)
...
#define ERR_INVALID_TRANSITION_MODE (0x05)
#define ERR_MISS_TRANSITION_TIME (0x06)
#define ERR_FPGA_TIMEOUT (0x07)
#define ERR_SYNC_NOT_READY (0x08)
#define ERR_INVALID_SYNC0_CYCLE (0x09)
